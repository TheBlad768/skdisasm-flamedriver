...
MusData_MinibossK:		include	"Sound/Music/Miniboss (Sonic & Knuckles).asm"
MusData_EndBoss:		include	"Sound/Music/Zone Boss.asm"
MusData_DDZ:			include	"Sound/Music/DDZ.asm"
MusData_Pachinko:		include	"Sound/Music/Pachinko.asm"
MusData_SpecialStage:		include	"Sound/Music/Special Stage.asm"
MusData_Slots:		include	"Sound/Music/Slots.asm"
MusData_Knuckles:			include	"Sound/Music/Knuckles (Sonic & Knuckles).asm"
...
MusData_TitleScreen:			include	"Sound/Music/Title (Sonic & Knuckles).asm"
MusData_ExtraLife:			include	"Sound/Music/1UP (Sonic & Knuckles).asm"
...
MusData_CreditsK:		include	"Sound/Music/Credits (Sonic & Knuckles).asm"
MusData_GameOver:		include	"Sound/Music/Game Over.asm"
MusData_Continue:		include	"Sound/Music/Continue (Sonic & Knuckles).asm"
MusData_GotThroughAct:		include	"Sound/Music/Level Outro.asm"
MusData_Invincibility:			include	"Sound/Music/Invincible (Sonic & Knuckles).asm"
MusData_DataSelect:			include	"Sound/Music/Menu (Sonic & Knuckles).asm"
MusData_FinalBoss:		include	"Sound/Music/Final Boss.asm"
MusData_Ending:		include	"Sound/Music/Game Complete (Sonic & Knuckles).asm"
...
Mus_Bank4_Start:	startBank
	Music_Master_Table
					include "Sound/UniBank.asm"
MusData_Gumball:		include	"Sound/Music/Gum Ball Machine.asm"
...
MusData_Credits3:		include	"Sound/Music/Credits (Sonic 3).asm"
MusData_CompetitionMenu:			include	"Sound/Music/Competition Menu.asm"
MusData_Drowning:			include	"Sound/Music/Countdown.asm"
MusData_Miniboss:		include	"Sound/Music/Miniboss (Sonic 3).asm"
